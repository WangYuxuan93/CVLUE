...
predict_result_path=/work/experiments/transformers/saves/chinese_clip-vqa-base-finetuned/result_ch_chinese.json

output_dir=/work/experiments/transformers/saves/chinese_clip-vqa-base-finetuned
