...
from models.model_grounding import ModelForGrounding
...
def main(args, config):
    ...
    model = ModelForGrounding(config=config)
    ...
    if args.evaluate:
        ...
        print('-----accumulate_steps------',config.get('accumulate_steps'))
        ...
        if utils.is_main_process():
            ...
            refer = REFER(config['refcoco_data'],dataset='refcocog', splitBy='umd')
