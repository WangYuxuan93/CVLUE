...
model=/work/experiments/transformers/saves/chinese_clip-vd-base-finetuned/checkpoint-720
cache=/tmp 
...
predict_result_path=/work/experiments/transformers/saves/chinese_clip-vd-base-finetuned/result_ch_chinese.json

output_dir=/work/experiments/transformers/saves/chinese_clip-vd-base-finetuned
...
python $main \
	...
	--num_train_epochs="20" \
	--push_to_hub &> logs/chinese_clip-vd-base-finetuned.log
